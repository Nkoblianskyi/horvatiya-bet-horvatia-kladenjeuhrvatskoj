        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-left">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-5">
              <span className="w-2 h-2 rounded-full bg-magazine-coral animate-pulse" />
              <span className="text-xs font-semibold text-white uppercase tracking-wider">Ažurirano za 2025</span>
            </div>

            {/* Headline */}
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold mb-4 leading-tight text-balance">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-magazine-coral hover:bg-magazine-coral/90 text-white font-semibold rounded-lg transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
            >
